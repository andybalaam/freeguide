XMLTV 0.5.51, Windows binary release
...
* Changes in this release (0.5.51)
tv_grab_eu_epgdata: new European grabber
tv_grab_es_miguiatv: new grapper for Spain

removed: tv_grab_nl,tv_grab_nc,tv_grab_no (use tv_grab_no_gfeed)
...
tv_grab_uk_rt: add title/subtitle processing for consistant programme info, 
...
-- Robert Eden, rmeden@yahoo.com, 2007-11-05
$Id: README.win32,v 1.80 2008/02/17 07:08:59 rmeden Exp $
