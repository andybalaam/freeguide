...
public class Utils
{
     ...
     */
    public static void execAndWait( 
        JFrame owner, String[] cmds, String commandType, Calendar date )
    {

        ExecutorDialog executor =
            new ExecutorDialog( owner, cmds, commandType, date );
     ...
     */
    public static void execAndWait( 
        JFrame owner, String[] cmds, String commandType )
    {

        // Show the command execution window
        ExecutorDialog executor =
            new ExecutorDialog( owner, cmds, commandType );
        executor.setVisible( true );
     ...
     * @param cmds DOCUMENT_ME!
     * @param commandType DOCUMENT_ME!
     * @param prefs DOCUMENT_ME!
     */
    public static void execAndWait( 
        JFrame owner, String[] cmds, String commandType, PreferencesGroup prefs )
    {
        ...
        // Show the command execution window
        ExecutorDialog executor =
            new ExecutorDialog( owner, cmds, commandType, prefs );
        executor.setVisible( true );
