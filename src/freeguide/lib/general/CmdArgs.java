 ...
 * arguments. By default all arguments are treated as if they expect some
 * data. Arguments which should be treated as boolean flags must be passed to
 * the constructor. Flags requiring data must be immediately followed by that
 * data (after a space).
 *
 * @author Andy Balaam
 * @version 2
...
public class CmdArgs
{
     ...
     *
     * @return true unless errors were encountered in the course of argument
     *         processing
     */
     ...
     *
     * @return the data for a flag or null if the flag was omitted or had no
     ...
     * @param name the String name of the flag required
     *
     * @return true if the flag was used at the command line, false otherwise
     */
     ...
     * a flag.
     *
     * @return the "blank" command line arguments not associated with a flag
     */
