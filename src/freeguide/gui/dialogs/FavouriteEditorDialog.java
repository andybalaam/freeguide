...
public class FavouriteEditorDialog extends FGDialog
{
    ...
    public FavouriteEditorDialog( 
        FGDialog owner, String title, Favourite favourite )
    {
        super( owner, title );
    ...
    private void getDetails(  )
    {
        ...
        {
            cmbDayOfWeek.setSelectedIndex( 
                favourite.getDayOfWeek(  ).intValue(  ) );
        }
    ...
    private void calcTxtName(  )
    {
        ...
        String name =
            FreeGuide.getCompoundMessage( "favourite_name_template", nameArgs );
