...
public class RemindersOptionPanel extends OptionPanel
{
    ...
    protected void doLoad( String prefix )
    {
        ...
        warningTextField.setText( 
            String.valueOf( 
                misc.getInt( prefix + "reminders_warning_secs", 300 ) ) );

        giveupTextField.setText( 
            String.valueOf( 
                misc.getInt( prefix + "reminders_give_up_secs", 600 ) ) );
    ...
    public boolean doSave(  )
    {
        ...
        misc.putInt( 
            ...
            Integer.parseInt( warningTextField.getText(  ) ) );

        misc.putInt( 
            "reminders_give_up_secs",
            Integer.parseInt( giveupTextField.getText(  ) ) );
