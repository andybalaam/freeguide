    ...
    ActionListener
{
    ...
    private DefaultMutableTreeNode buildMenuTree(  )
    {
        ...
        DefaultMutableTreeNode layoutLeaf =
            new DefaultMutableTreeNode( new LayoutOptionPanel( this ) );
        trunk.add( layoutLeaf );

        DefaultMutableTreeNode colourLeaf =
            new DefaultMutableTreeNode( new ColoursOptionPanel( this ) );
        trunk.add( colourLeaf );

        DefaultMutableTreeNode timeLeaf =
            new DefaultMutableTreeNode( new TimeOptionPanel( this ) );
        trunk.add( timeLeaf );
        ...
        DefaultMutableTreeNode grabberLeaf =
            new DefaultMutableTreeNode( new DownloadingOptionPanel( this ) );
        advancedBranch.add( grabberLeaf );

        DefaultMutableTreeNode dirLeaf =
            new DefaultMutableTreeNode( new DirectoriesOptionPanel( this ) );
