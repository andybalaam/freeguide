...
/**
 * This class provides an object that contains, and maintains a vector of
 * dates that are a segment of a filename. The date segment currently must be
 * between the first "-" character, and the first "." character. (FIXME) The
 * directory path, and filename regex are configurable.
 *
    ...
    public void updateDates(  )
    {
        ...
        for( int i = 0; i < dir.length; i++ )
        {
            ...
            if( ndx < 0 )
            {
                ...
                {
                    cdt.setTime( 
                        ViewerFrame.fileDateFormat.parse( d.substring( 0, 8 ) ) );
