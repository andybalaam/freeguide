...
public class ViewerFrame extends javax.swing.JFrame implements Progressor
{
        ...
        if( !xmltvLoader.hasData(  ) )
        {
            ...
            int r =
                JOptionPane.showConfirmDialog( 
                    this, oa, FreeGuide.msg.getString( "download_listings_q" ),
    ...
    private void findInitialDate(  )
    {
        ...
        Time day_start_time =
            FreeGuide.prefs.misc.getTime( "day_start_time", new Time( 0, 0 ) );
    ...
    {
        String currentChannelSetString =
            FreeGuide.prefs.screen.get( 
                "viewer_channel_set", CHANNEL_SET_ALL_CHANNELS );

        currentChannelSet =
            getChannelSetInterfaceFromName( currentChannelSetString );
    }
    ...
    private void drawStaticGUI(  )
    {
        ...
        mbtResetIcon.setText( 
            FreeGuide.msg.getString( "reset_to_default_icon" ) );
...
//        GuiUtils.centerDialog( this, "viewer", 640, 400 );
        ...
        butPreviousDay.setFont( new java.awt.Font( "Dialog", 0, 10 ) );
        ...
        butNextDay.setFont( new java.awt.Font( "Dialog", 0, 10 ) );
        ...
        butRevertToFavourites.setText( 
            FreeGuide.msg.getString( "reset_programmes" ) );
        ...
        butPrint.setText( 
            FreeGuide.msg.getString( "print_this_personalised_listing" ) );
        ...
        comTheDateItemListener = ( new java.awt.event.ItemListener(  )
                {
        ...
        comChannelSetItemListener = ( new java.awt.event.ItemListener(  )
                {
                    public void itemStateChanged( 
                        java.awt.event.ItemEvent evt )
                    {
        ...
        boolean alignTextToLeftOfScreen =
...
//        GuiUtils.resizeToContents( comChannelSet );
    ...
    private void drawProgrammes(  )
    {
        ...
        int channelHeight =
            FreeGuide.prefs.screen.getInt( 
                "channel_height", FreeGuide.CHANNEL_HEIGHT );
        int halfVerGap =
            FreeGuide.prefs.screen.getInt( 
                "vertical_gap", FreeGuide.VERTICAL_GAP );
        int halfHorGap =
            FreeGuide.prefs.screen.getInt( 
                "horizontal_gap", FreeGuide.HORIZONTAL_GAP );
        int panelWidth =
            FreeGuide.prefs.screen.getInt( 
                "panel_width", FreeGuide.PANEL_WIDTH );

        ProgrammeJLabel.setTickedColour( 
            FreeGuide.prefs.screen.getColor( 
                "programme_chosen_colour", FreeGuide.PROGRAMME_INGUIDE_COLOUR ) );

        ProgrammeJLabel.setMovieColour( 
            FreeGuide.prefs.screen.getColor( 
                "programme_movie_colour", FreeGuide.PROGRAMME_MOVIE_COLOUR ) );

        ProgrammeJLabel.setNonTickedColour( 
            FreeGuide.prefs.screen.getColor( 
                "programme_normal_colour",
                FreeGuide.PROGRAMME_NOTINGUIDE_COLOUR ) );

        ProgrammeJLabel.setHeartColour( 
            FreeGuide.prefs.screen.getColor( 
        ...
        int fontStyle =
            FreeGuide.prefs.screen.getInt( "font_style", Font.PLAIN );
        int fontSize = FreeGuide.prefs.screen.getInt( "font_size", 12 );

        boolean drawTime =
            FreeGuide.prefs.screen.getBoolean( "display_programme_time", true );
        ...
        for( int c = 0; c < num_chans; c++ )
        {
            ...
            Channel curChan = currentChannelSet.getChannel( c );
                        ...
                        "customIcon." + ctxt.getChannel(  ).getID(  ) ) != null ) )
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        // filename
                        File cache =
                            new File( ctxt.getChannel(  ).getIconFileName(  ) );
        ...
        for( int c = 0; c < num_chans; c++ )
        {
            ...
            ctxt.setBounds( 
                0, ( ( halfVerGap * 2 ) + ( c * channelHeight ) ) - 1,
                maxChannelWidth, channelHeight - ( halfVerGap * 4 ) );
        }
        ...
        channelNamePanel.setPreferredSize( 
            new Dimension( 
                maxChannelWidth,
                ( currentChannelSet.getNoChannels(  ) * channelHeight ) + 50 ) );
        ...
        Dimension tmp =
            new Dimension( 
                panelWidth, currentChannelSet.getNoChannels(  ) * channelHeight );
        ...
        tmp = new Dimension( 
                panelWidth, timePanel.getPreferredSize(  ).height );
    ...
    /**
     * Check that the chosen channel set exists, and if not, sets it to "- All
     * Channels -".
     */
    private void checkCurrentChannelSet(  )
    {
        ...
        {
            if( 
                currentChannelSet.getChannelSetName(  ).equals( 
     ...
     *
     * @param channelSetName DOCUMENT ME!
     *
     * @return DOCUMENT_ME!
     */
        ...
        String channelSetName )
    {
        ...
        for( int i = 0; i < channelSetsList.length; i++ )
        {
            ...
            if( 
                channelSetsList[i].getChannelSetName(  ).equals( 
                        channelSetName ) )
            {
    ...
    public void reShow(  )
    {
        ...
        currentChannelSet =
            getChannelSetInterfaceFromName( 
                currentChannelSet.getChannelSetName(  ) );
    ...
    public void mbtConfigureActionPerformed( java.awt.event.ActionEvent evt )
    {
        ...
        Utils.execAndWait( 
            this, FreeGuide.prefs.getCommands( "tv_config" ),
    ...
    public void resetSelections(  )
    {
        ...
        for( 
            Iterator i =
                ( (ProgrammeStripModel)programmesPanel.getModel(  ) ).getAll(  )
                  .iterator(  ); i.hasNext(  ); )
        {
    ...
    public void comChannelSetItemStateChanged( java.awt.event.ItemEvent evt )
    {
        ...
        else
        {
            ...
            {
                FreeGuide.log.info( 
                    FreeGuide.msg.getString( "channel_set_name_not_found" )
                    + " " + channelSetString );
    ...
    public void mbtUserGuideActionPerformed( java.awt.event.ActionEvent evt )
    {
        ...
        String[] cmds =
            Utils.substitute( 
                ...
                "%filename%", "%misc.doc_directory%" + fs + "userguide.html" );
    ...
    {
        boolean updated =
            centreDialogAndRun( new ChannelSetListDialog( this, xmltvLoader ) );
    ...
    public void mbtFavouritesActionPerformed( java.awt.event.ActionEvent evt )
    {
        ...
        boolean updated =
            centreDialogAndRun( new FavouritesListDialog( this ) );
    ...
    {
        Utils.execAndWait( 
            this, FreeGuide.prefs.getCommands( "tv_grab" ),
