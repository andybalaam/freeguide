...
{
    protected static final String HOME_URL = "http://freeguide-tv.sourceforge.net";
    ...
    {
        super( parent, Application.getInstance().getLocalizedMessage(
    ...
    private void initComponents()
    {
        ...
        JLabel labTopMessage = new javax.swing.JLabel( Application
        ...
        butURL = new javax.swing.JButton( Application.getInstance()
            .getLocalizedMessage( "go_to_the_web_site" ) );
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        pane.add( butURL, gridBagConstraints );
        butURL.addActionListener( new java.awt.event.ActionListener()
        {
        ...
        chkTellMeAgain = new javax.swing.JCheckBox( Application.getInstance()
            .getLocalizedMessage( "check_new_version_every_time" ), true );
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.CENTER;
        pane.add( chkTellMeAgain, gridBagConstraints );
        butOK = new javax.swing.JButton( Application.getInstance()
            .getLocalizedMessage( "ok" ) );
    ...
    {
        LaunchBrowserOrError.launchBrowserOrError( HOME_URL );
    }
