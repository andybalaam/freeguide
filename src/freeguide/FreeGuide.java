...
public class FreeGuide
{
    ...
    public final static Color PROGRAMME_MOVIE_COLOUR =
    ...
    public FreeGuide( String[] args )
    {
        ...
        {
            prefs.misc.put( 
                "doc_directory", arguments.getValue( "doc_directory" ) );
        ...
        {
            prefs.misc.put( 
                "install_directory", arguments.getValue( "install_directory" ) );
     ...
     * @param messageArguments DOCUMENT ME!
     *
     * @return DOCUMENT_ME!
     */
    public static String getCompoundMessage( 
        String template, Object[] messageArguments )
    {
