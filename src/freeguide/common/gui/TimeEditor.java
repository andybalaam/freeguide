...
public class TimeEditor extends JFormattedTextField {
    ...
    protected static final Pattern TIME_PATTERN = Pattern.compile("(\\d{1,2}):(\\d{2})");
            ...
            public AbstractFormatter getFormatter(JFormattedTextField tf) {
                return new AbstractFormatter() {
                    public Object stringToValue(String text) throws ParseException {
                        ...
                        if (!m.matches()) {
                            throw new ParseException("Error parse: " + text, 0);
                        }
                    ...
                    public String valueToString(Object value) throws ParseException {
                        ...
                        return formatTo2Digit(v1) + ":" + formatTo2Digit(v2);
                    }
                };
            }
        });
    ...
    protected void setupKeymap() {
        final Keymap keymap = JTextField.addKeymap(this.getClass().getName(), getKeymap());
        keymap.addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0), new KeyPressed(KeyEvent.VK_UP));
        keymap.addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0), new KeyPressed(KeyEvent.VK_DOWN));
        setKeymap(keymap);
    }
    ...
    protected class KeyPressed extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                int val = Integer.parseInt(pos <= div ? text.substring(0, div) : text.substring(div + 1));
                val += diff;
                ...
                if (pos <= div) {
                    ...
                    text = text.substring(0, div + 1) + formatTo2Digit(val);
                }
                setText(text);
