...
public class StripView extends JPanel implements Scrollable
{
     ...
     */
    public StripView( final HorizontalViewer parent )
    {
        super(  );
     ...
     */
    public StripView( 
        HorizontalViewer parent, Model model, StripRenderer renderer )
    {
        this( parent );
...
*/
    public void doLayout(  )
    {
        ...
        {
            channelHeight = parent.config.sizeChannelHeight;
        ...
        public void keyPressed( KeyEvent e )
        {
            ...
            else
            {
                Application.getInstance(  ).getLogger(  ).finest( 
                    "nowhere to dispatch" ); // TODO DEBUG
