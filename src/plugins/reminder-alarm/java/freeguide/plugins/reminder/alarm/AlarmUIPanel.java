...
public class AlarmUIPanel extends JPanel
{
    ...
    private void initialize(  )
    {
        ...
        jLabel1.setText( 
            localizer.getLocalizedMessage( "give_up_after_secs" ) );
        ...
        jLabel.setText( localizer.getLocalizedMessage( "seconds_warning" ) );
    ...
    public JCheckBox getCbRemind(  )
    {
        ...
        if( cbRemind == null )
        {
            ...
            cbRemind.setText( 
                localizer.getLocalizedMessage( "remind_me_of_progs" ) );
