...
public class ConfigGuesser
{
    ...
    private static String checkValidTime( String time, String whatFor )
    {
        ...
        return FreeGuide.msg.getLocalizedMessage( 
            "the_time_you_gave_not_hhmm_template", messageArguments );
    ...
    private static String checkNumeric( String number, String whatFor )
    {
        ...
        if( number == null )
        {
            ...
            return FreeGuide.msg.getLocalizedMessage( 
                "option_is_blank_template", messageArguments );
        ...
        catch( NumberFormatException e )
        {
            ...
            return FreeGuide.msg.getLocalizedMessage( 
                "option_not_numeric", messageArguments );
    ...
    private static String checkDirWriteable( File dir, String whatFor )
    {
        ...
        try
        {
            ...
            return FreeGuide.msg.getLocalizedMessage( 
                "dir_isnt_writeable", messageArguments );
        ...
        catch( java.io.IOException e )
        {
            ...
            return FreeGuide.msg.getLocalizedMessage( 
                "error_creating_dir", messageArguments );
