 ...
 * regular expression. Doesn't implement FilenameFilter as that makes the
 * user work too hard I reckon.
 *
 * @author Andy Balaam
 * @version 1
 */
    ...
    implements java.io.FileFilter
{
    ...
    public FilenameFilter( String regex )
    {
        this( 
            regex,
            FreeGuide.msg.getString( "filenames_matching" ) + " /" + regex
            + "/", true );
     ...
     */
    public FilenameFilter( 
        String regex, String description, boolean allowDirectories )
    {
