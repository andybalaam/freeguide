...
public class HorizontalViewer extends BaseModule implements IModuleViewer
{
    ...
    /** DOCUMENT ME! */
    public static final String ID = "Horizontal";
    ...
    */
    ...
    private void checkForNoData(  )
    {
        ...
        if( !FreeGuide.storage.getInfo(  ).isEmpty(  ) )
        {
    ...
    private void drawProgrammes(  )
    {
        ...
        synchronized( this )
        {
            ...
            if( config.displayTime )
            {
                ...
                timeFormat.setTimeZone( FreeGuide.getTimeZone(  ) );
    ...
    protected void prepareDateList(  )
    {
         ...
         */
        IStorage.Info info = FreeGuide.storage.getInfo(  );

        Calendar cal =
            GregorianCalendar.getInstance( 
                FreeGuide.getTimeZone(  ), Locale.ENGLISH );
        ...
        comboBoxDateFormat.setTimeZone( FreeGuide.getTimeZone(  ) );
