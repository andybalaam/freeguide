...
Summary: A TV Guide
Name: freeguide-impexp-xmltv
Provides: freeguide-impexp-xmltv
...
%description
This is a plugin for FreeGuide to import/export listings to/from XMLTV format.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir} -Dinstall_bin_dir=$RPM_BUILD_ROOT/%{_bindir} -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=impexp-xmltv install-linux-plugin


%files
%{_datadir}/freeguide/plugins/impexp-xmltv.jar
