...
Summary: A TV Guide
Name: freeguide-storage-serfiles
Provides: freeguide-storage-serfiles
...
%description
This is a plugin for FreeGuide to store its listings info as serialised Java objects.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir} -Dinstall_bin_dir=$RPM_BUILD_ROOT/%{_bindir} -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=storage-serfiles install-linux-plugin


%files
%{_datadir}/freeguide/plugins/storage-serfiles.jar
