...
Summary: A TV Guide
Name: freeguide-grabber-vsetv
Provides: freeguide-grabber-vsetv
...
%description
This is a grabber for FreeGuide to download listings from vsetv.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir} -Dinstall_bin_dir=$RPM_BUILD_ROOT/%{_bindir} -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=grabber-vsetv install-linux-plugin


%files
%{_datadir}/freeguide/plugins/grabber-vsetv.jar
