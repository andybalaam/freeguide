...
Summary: A TV Guide
Name: freeguide-grabber-xmltv
Provides: freeguide-grabber-xmltv
Requires: freeguide-base >= 0.10.2
          xmltv-grabbers >= 0.5.40
Version: 1
Release: 1
...
%description
This is a grabber for FreeGuide to download listings using the XMLTV tools.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir} -Dinstall_bin_dir=$RPM_BUILD_ROOT/%{_bindir} -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=grabber-xmltv install-linux-plugin


%files
%{_datadir}/freeguide/plugins/grabber-xmltv.jar
