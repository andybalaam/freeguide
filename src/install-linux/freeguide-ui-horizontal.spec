...
Summary: A TV Guide
Name: freeguide-ui-horizontal
Provides: freeguide-ui-horizontal
...
%description
This is a plugin for FreeGuide to display listings in a horizontal format.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir} -Dinstall_bin_dir=$RPM_BUILD_ROOT/%{_bindir} -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=ui-horizontal install-linux-plugin


%files
%{_datadir}/freeguide/plugins/ui-horizontal.jar
