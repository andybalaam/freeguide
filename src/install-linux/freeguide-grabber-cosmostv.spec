...
Summary: A TV Guide
Name: freeguide-grabber-cosmostv
Provides: freeguide-grabber-cosmostv
...
%description
This is a grabber for FreeGuide to download listings from cosmostv.
...
%install
ant -Dinstall_share_dir=$RPM_BUILD_ROOT/%{_datadir}  -Dinstall_doc_dir=$RPM_BUILD_ROOT/%{_datadir}/doc/freeguide -Dinstall_real_doc_dir=%{_datadir}/doc/freeguide -Dplugin_name=grabber-cosmostv install-linux-plugin


%files
%{_datadir}/freeguide/plugins/grabber-cosmostv.jar
