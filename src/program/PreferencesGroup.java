...
public class PreferencesGroup {
    ...
    public PreferencesGroup() {
        ...
        channels = new FGPreferences("channels");
    ...
    /**
     *  Gets the channelSets attribute of the FreeGuidePreferencesGroup object
     *
     *@return    The channelSets value
     */
