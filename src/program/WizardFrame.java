...
public class WizardFrame extends javax.swing.JFrame {
     ...
     */
    public WizardFrame(String title, WizardPanel[] panels, Launcher launcher) {
     ...
     */
    public WizardFrame(String title, WizardPanel[] panels, Launcher launcher, Object finishObject, Method finishMethod) {
