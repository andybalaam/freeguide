...
public class ColoursOptionPanel extends OptionPanel implements MouseListener,
    ...
    public void doConstruct() {
        ...
        movieButton = newLeftJButton(
            FreeGuide.msg.getString( "movie_colour" ) + ":" );
        ...
        channelButton = newLeftJButton(
            FreeGuide.msg.getString( "channel_colour" ) + ":" );
        ...
        heartButton = newLeftJButton(
            FreeGuide.msg.getString( "heart_colour" ) + ":" );
    ...
    protected void doLoad( String prefix ) {
        ...
        inGuideTextField.setBackground( screen.getColor(
    ...
    public boolean doSave() {
        ...
        updated = screen.updateColor( "",
                inGuideTextField.getBackground() ) || updated;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        Color col = JColorChooser.showDialog( this,
            FreeGuide.msg.getString( "choose_a_colour" ) ,
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Color col = JColorChooser.showDialog( this, FreeGuide.msg.getString( "choose_a_colour" ),
