...
public class TimeOptionPanel extends OptionPanel {
    ...
    public void doConstruct() {
        ...
        JLabel dayStartLabel = newLeftJLabel( FreeGuide.msg.getString(
            "day_starts_at" ) + ":" );
        dayStartTextField = newRightJTextField();
        
        JLabel twelveHourLabel = newLeftJLabel( FreeGuide.msg.getString(
            "time_format" ) + ":" );
        ...
        JLabel showTimesLabel = newLeftJLabel( FreeGuide.msg.getString(     
            "show_programme_times" ) );
