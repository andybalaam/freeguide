...
public class DownloadingOptionPanel extends OptionPanel {
    ...
    public void doConstruct() {
        ...
        JLabel startTodayLabel = newLeftJLabel(
            FreeGuide.msg.getString( "start_grabbing" ) + ":" );
        ...
        JLabel dayStartLabel = newLeftJLabel(
        ...
        JLabel todayOffsetLabel = newLeftJLabel(
            FreeGuide.msg.getString( "today_offset" ) + ":" );
        ...
        JLabel daysLabel = newLeftJLabel(
        ...
        options[ExecutorDialog.REDOWNLOAD_ALWAYS] = FreeGuide.msg.getString(
            "always" ) ;
        options[ExecutorDialog.REDOWNLOAD_NEVER] = FreeGuide.msg.getString(
            "never" ) ;
        options[ExecutorDialog.REDOWNLOAD_ASK] = FreeGuide.msg.getString(
            "ask" ) ;
        JLabel redownloadLabel = newLeftJLabel( FreeGuide.msg.getString(
            "re_download_q" )  );
        ...
        JLabel modalLabel = newLeftJLabel( FreeGuide.msg.getString(
        ...
        JLabel commandLabel = newLeftJLabel( FreeGuide.msg.getString(
            "grabber_command" ) + ":" );
        ...
        JLabel configLabel = newLeftJLabel( FreeGuide.msg.getString(
            "config_command" ) + ":" );
