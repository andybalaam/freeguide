...
public class LayoutOptionPanel extends OptionPanel implements ActionListener,
    ...
    public void doConstruct() {
        ...
        JLabel lookAndFeelLabel = newLeftJLabel( FreeGuide.msg.getString(
            "look_and_feel" ) + ":" );
        ...
        JLabel channelHeightLabel = newLeftJLabel( FreeGuide.msg.getString(
            "channel_height" ) + ":" );
        ...
        JLabel panelWidthLabel = newLeftJLabel( FreeGuide.msg.getString(
            "width_of_1hr" ) + ":" );
        ...
        JLabel fontLabel = newLeftJLabel( FreeGuide.msg.getString( "font" )
            + ":" );
        fontDemoText = newMiddleJTextField();
        fontDemoText.setEnabled( false );
        fontButton = newRightJButton( FreeGuide.msg.getString( "modify" )
            + "..." );
        fontButton.setMnemonic( KeyEvent.VK_M );
        
        JLabel alignLeftLabel = newLeftJLabel( FreeGuide.msg.getString(
            "moving_names" )  );
        ...
        JLabel printDeltaLabel = newLeftJLabel( FreeGuide.msg.getString(
            "print_time_delta" )  );
        ...
        JLabel tooltipLabel = newLeftJLabel( FreeGuide.msg.getString(
            "show_tooltips" )  );
        ...
        fontDialog = new FontChooserDialog( parent, FreeGuide.msg.getString(
            "choose_font" ) , true,
