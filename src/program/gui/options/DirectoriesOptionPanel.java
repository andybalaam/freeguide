...
public class DirectoriesOptionPanel extends OptionPanel {
    ...
    public void doConstruct() {
        ...
        JLabel workingLabel = newLeftJLabel(
            FreeGuide.msg.getString( "working_dir" ) + ":" );
        ...
        JLabel xmltvLabel = newLeftJLabel(
            FreeGuide.msg.getString( "xmltv_dir" ) + ":" );
        xmltvTextField = newRightJTextField();
        xmltvLabel.setLabelFor(xmltvTextField);
        xmltvLabel.setDisplayedMnemonic(KeyEvent.VK_X);
        
        JLabel configLabel = newLeftJLabel(
            FreeGuide.msg.getString( "grabber_config" ) + ":" );
    ...
    public String toString() {
        ...
        return FreeGuide.msg.getString( "directories" ) ;
