...
public class ExecutorFrame extends javax.swing.JFrame implements Runnable,
     ...
     */
    public ExecutorFrame(String[] cmds, String commandType, Calendar date) {
     ...
     *@param  commandType  Description of the Parameter
     */
    public ExecutorFrame(String[] cmds, String commandType) {
		this(cmds, commandType, FreeGuide.prefs);
