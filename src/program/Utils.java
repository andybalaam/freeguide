...
public class Utils {
     ...
     */
    public static void execAndWait(String[] cmds, String commandType,
            Launcher launcher, Calendar date) {

        // Show the command execution window
        launcher.setVisible(false);
        ExecutorFrame executor = new ExecutorFrame(launcher, cmds, commandType, date);
    ...
    public static void execAndWait(String[] cmds, String commandType,
        ...
        // Show the command execution window
        launcher.setVisible(false);
        ExecutorFrame executor = new ExecutorFrame(launcher, cmds, commandType);
        executor.setVisible(true);
